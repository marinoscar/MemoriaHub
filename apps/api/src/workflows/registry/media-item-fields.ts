...
import {
  emptyParamsSchema,
  addToAlbumParamsSchema,
  removeFromAlbumParamsSchema,
  addTagsParamsSchema,
  removeTagsParamsSchema,
  setFavoriteParamsSchema,
  setCapturedAtParamsSchema,
  assignPersonParamsSchema,
  removePersonParamsSchema,
  setLocationParamsSchema,
  moveToCircleParamsSchema,
  rerunEnrichmentParamsSchema,
  resolveBurstGroupParamsSchema,
  resolveDuplicateGroupParamsSchema,
  BASE_ACTION_PERMISSION,
  HARD_DELETE_PERMISSION,
  RESOLVE_GROUP_PERMISSION,
  MOVE_TO_CIRCLE_PERMISSION,
} from '../actions/action-params.schema';
import {
  whereType,
  whereFavorite,
  whereDateRange,
...
/**
 * Media Item action catalog (the "Then" half — issue #140). Each descriptor
 * carries a Zod `paramsSchema`, a typed `permission` requirement, trigger
 * compatibility, and reversible/high-impact advisories. Execution is performed
 * by `WorkflowActionExecutor`; per-action authorization is resolved from
 * `permission` by the run-create / approval path.
 *
 * NOTE: the Phase-1 stubs `set_capture_date` + `shift_capture_date` were
 * reconciled into the single canonical `set_captured_at` action
 * (`{ mode: 'set'|'shift'|'clear' }`).
 */
export const MEDIA_ITEM_ACTIONS: WorkflowActionDescriptor[] = [
  ...
  },
  {
    ...
    destructive: true,
    paramsSchema: emptyParamsSchema,
    permission: HARD_DELETE_PERMISSION,
    triggerCompatibility: 'manual_only',
    reversible: false,
    highImpact: true,
  },
  {
  ...
  },
  {
    type: 'add_to_album',
    label: 'Add to album',
    paramsSchema: addToAlbumParamsSchema,
    permission: BASE_ACTION_PERMISSION,
    triggerCompatibility: 'all',
    reversible: true,
    highImpact: false,
  },
  {
    ...
    paramsSchema: removeFromAlbumParamsSchema,
    permission: BASE_ACTION_PERMISSION,
    triggerCompatibility: 'all',
    reversible: true,
    highImpact: false,
  ...
  },
  {
    type: 'set_favorite',
    label: 'Set favorite',
    paramsSchema: setFavoriteParamsSchema,
    permission: BASE_ACTION_PERMISSION,
    triggerCompatibility: 'all',
    reversible: true,
    highImpact: false,
  ...
  {
    type: 'set_captured_at',
    label: 'Set capture date',
    paramsSchema: setCapturedAtParamsSchema,
    permission: BASE_ACTION_PERMISSION,
    triggerCompatibility: 'all',
    reversible: true,
    highImpact: false,
  },
  {
    type: 'assign_person',
    label: 'Assign person',
    paramsSchema: assignPersonParamsSchema,
    permission: BASE_ACTION_PERMISSION,
    triggerCompatibility: 'all',
    reversible: true,
    highImpact: false,
  },
  {
    type: 'remove_person',
    label: 'Remove person',
    paramsSchema: removePersonParamsSchema,
    permission: BASE_ACTION_PERMISSION,
    triggerCompatibility: 'all',
    reversible: true,
    highImpact: false,
  },
  {
    type: 'set_location',
    label: 'Set location',
    paramsSchema: setLocationParamsSchema,
    permission: BASE_ACTION_PERMISSION,
    triggerCompatibility: 'all',
    reversible: true,
    highImpact: false,
  ...
  {
    type: 'move_to_circle',
    label: 'Move to circle',
    paramsSchema: moveToCircleParamsSchema,
    permission: MOVE_TO_CIRCLE_PERMISSION,
    triggerCompatibility: 'all',
    // Reversible (move it back), but high-impact: cross-circle cascade +
    // full re-enrichment fan-out in the target circle.
    reversible: true,
    highImpact: true,
  },
  {
    type: 'rerun_enrichment',
    label: 'Re-run enrichment',
    paramsSchema: rerunEnrichmentParamsSchema,
    permission: BASE_ACTION_PERMISSION,
    triggerCompatibility: 'all',
    reversible: true,
    highImpact: false,
  ...
  // ----------------------------- Review-queue -----------------------------
  {
    type: 'resolve_burst_group',
    label: 'Resolve burst group',
    paramsSchema: resolveBurstGroupParamsSchema,
    permission: RESOLVE_GROUP_PERMISSION,
    triggerCompatibility: 'all',
    reversible: true,
    highImpact: false,
  },
  {
    type: 'dismiss_burst_group',
    label: 'Dismiss burst group',
    paramsSchema: emptyParamsSchema,
    permission: BASE_ACTION_PERMISSION,
    triggerCompatibility: 'all',
    reversible: true,
  ...
  {
    type: 'resolve_duplicate_group',
    label: 'Resolve duplicate group',
    paramsSchema: resolveDuplicateGroupParamsSchema,
    permission: RESOLVE_GROUP_PERMISSION,
    triggerCompatibility: 'all',
    reversible: true,
    highImpact: false,
  ...
  {
    type: 'dismiss_duplicate_group',
    label: 'Dismiss duplicate group',
    paramsSchema: emptyParamsSchema,
    permission: BASE_ACTION_PERMISSION,
    triggerCompatibility: 'all',
    reversible: true,
  ...
  },
  {
    ...
    label: 'Accept location suggestion',
    paramsSchema: emptyParamsSchema,
    permission: BASE_ACTION_PERMISSION,
    triggerCompatibility: 'all',
    reversible: true,
  ...
  {
    type: 'reject_location_suggestion',
    label: 'Reject location suggestion',
    paramsSchema: emptyParamsSchema,
    permission: BASE_ACTION_PERMISSION,
    triggerCompatibility: 'all',
    reversible: true,
