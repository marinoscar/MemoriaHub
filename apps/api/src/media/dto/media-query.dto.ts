...
export const mediaFilterFields = {
  ...
  missingCapturedAt: z.string().optional().transform(v => v === 'true' ? true : v === 'false' ? false : undefined),
  missingCamera: z.string().optional().transform(v => v === 'true' ? true : v === 'false' ? false : undefined),
