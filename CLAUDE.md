...
- `pictureEnhancement.retentionHours` — integer, 1–720, default `72`; how long unapplied staging previews live before `PictureEnhancementPurgeTask`'s hourly `picture_enhancement_purge` job reaps them
