...
- [Social Media Detection](docs/specs/social-media-detection.md) — detector registry model, tiered signal pipeline (container metadata → filename → OCR), tesseract.js keyless WASM OCR, system-tag protection matrix, `media_social_status` lifecycle, upload-enqueue/rerun/backfill, adding new platforms
