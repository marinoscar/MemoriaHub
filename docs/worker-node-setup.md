...
### 5.1 Prerequisite: run your own local CompreFace sidecar
...
### 5.3 Hard-fail behavior — no silent fallback to Human
...
### 5.5 How this differs from the CLIP/Human model-file pattern
